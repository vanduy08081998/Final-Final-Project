      ...
      <tbody>
        <tr>
          <td class="esd-email-paddings" valign="top">
                                        ...
                                        <tr>
                                          <td class="esd-block-image es-m-p0l es-p15l es-m-txt-c">
                                            <a href="#" target="_blank"><img
                                                src="https://demo.stripocdn.email/content/guids/videoImgGuid/images/logo_me5.png"
                                                alt="Petshop logo" title="Petshop logo" width="200" style="
                                                                                                        display: block;
                                                                                                        padding: 20px;
                                                                                                    " /></a>
                                          </td>
                ...
                <tr>
                  <td class="esd-stripe" esd-custom-block-id="1754" align="center">
                    <table class="es-content-body" width="600" cellspacing="0" cellpadding="0" bgcolor="#ffffff"
                      ...
                      <tbody>
                        <tr>
                          <td class="esd-structure es-p10t es-p10b es-p20r es-p20l" esd-general-paddings-checked="false"
                            align="left">
                            <table width="100%" cellspacing="0" cellpadding="0">
                              <tbody>
                                <tr>
            ...
            <table class="es-content" cellspacing="0" cellpadding="0" align="center" style="padding-top: 20px; min-width: 600px">
              <tbody>
                <tr>
                                  ...
                                  <td class="es-m-p20b esd-container-frame">
                                    <table style="
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td class="esd-block-text es-p20b es-p20r es-p20l" align="left" style="
                                                                                                padding: 20px;
                                                                                            ">
                                            <table style="
                                                                                                    width: 100%;
                                              ...
                                              <tbody>
                                                ...
                                                <tr>
                                                  ...
                                                  <td style="
                                                                                                                ...
                                                                                                                line-height: 150%;
                                                                                                            ">
                                                    {{                                                     \DB::table('shipping_method')->where('id', $order->shipping_status)->first()->shipping_method }}
                                                  </td>
                                                </tr>
                                              </tbody>
                                            </table>
                  ...
                  <td class="esd-stripe" esd-custom-block-id="1758" align="center">
                    <table class="es-content-body" width="600" cellspacing="0" cellpadding="0" bgcolor="#ffffff"
                      ...
                      <tbody>
                        <tr>
                          <td class="esd-structure es-p10t es-p10b es-p20r es-p20l" esd-general-paddings-checked="false"
                            ...
                            <table class="es-left" cellspacing="0" cellpadding="0" align="left"
                              ...
                              <tbody>
                                <tr>
                                  <td class="es-m-p0r es-m-p20b esd-container-frame" width="270" valign="top"
                                    align="center">
                                    <table width="100%" cellspacing="0" cellpadding="0">
                                      <tbody>
                                        <tr>
                                ...
                                <tr>
                                  <td class="esd-container-frame" width="560" valign="top" align="center">
                                    <table width="100%" cellspacing="0" cellpadding="0">
                                      <tbody>
                                        <tr>
                                          <td class="esd-block-spacer es-p10b" align="center" style="
                                                                                                font-size: 0;
                                                                                            ">
                        ...
                        <tr>
                          <td class="esd-structure es-p5t es-p10b es-p20r es-p20l" esd-general-paddings-checked="false">
                    ...
                    <table class="es-right" cellspacing="0" cellpadding="0" style="padding-top: 20px">
                      <tbody>
                        <tr>
                        ...
                        <tr>
                          <td class="esd-structure es-p20" esd-general-paddings-checked="false" align="left">
                            <table class="es-left" cellspacing="0" cellpadding="0" align="left" style="
                              ...
                              <tbody>
                                <tr>
                                  <td class="es-m-p0r es-m-p20b esd-container-frame" width="178" valign="top"
                                    align="center">
                                    <table width="100%" cellspacing="0" cellpadding="0">
                                      <tbody>
                                        @php
                                ...
                                <tr>
                                  <td class="esd-container-frame" width="362" align="left">
                                    <table width="100%" cellspacing="0" cellpadding="0">
                                      <tbody>
                                        <tr>
                                          <td class="esd-block-image es-m-p0l es-m-txt-c" align="center" style="
                                                                                                font-size: 0px;
                                                                                            ">
                                            <a href target="_blank"><img
                                                src="https://demo.stripocdn.email/content/guids/videoImgGuid/images/logo_me5.png"
                                                alt="Petshop logo" title="Petshop logo" width="108" style="
                                                                                                        display: block;
                                                                                                    " /></a>
                                          </td>
                                        </tr>
