                ...
                <tr>
                    <td class="esd-email-paddings" valign="top">
                                                                    ...
                                                                    <td class="es-m-p0r esd-container-frame" width="180"
                                                                        ...
                                                                        <table width="100%" cellspacing="0"
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td
                                                                                        class="esd-block-image es-m-p0l es-p15l es-m-txt-c">
                                                                                        <a href="#" target="_blank"><img
                                                                                                src="https://demo.stripocdn.email/content/guids/videoImgGuid/images/logo_me5.png"
                                                                                                alt="Petshop logo"
                                                                                                title="Petshop logo"
                                                                                                width="200"
                                                                                                style="display: block; padding: 20px;"></a>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p10t es-p15b"
                                                                                        align="center">
                                                                                        <h1 style="color: #ff5e57;">Cảm
                                                                                            Ơn Quý Khách Hàng!</h1>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="es-m-p20b esd-container-frame">
                                                                        <table
                                                                            style="background-color: #f5f6fa; border-color: #f5f6fa; border-collapse: separate; border-width: 1px 0px 1px 1px; border-style: solid; border-radius: 20px;"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="esd-container-frame">
                                                        <table
                                                            style="background-color: #fbc531; border-collapse: separate; border-width: 1px; border-style: solid; border-color: #efefef; border-radius: 20px;"
                                                            width="100%" cellspacing="0" cellpadding="0"
                                                            bgcolor="#fbc531">
                                                            <tbody>
                                                                <tr>
                        ...
                        <table cellpadding="0" cellspacing="0" class="es-footer" align="center"
                            style="padding-top: 20px; background-color: #d2dae2;">
                            <tbody>
                                <tr>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-m-txt-c"
                                                                                        align="left">
                                                                                        <p><strong>BigDeal</strong>-
                                                                                            Siêu thi trực
                                                                                            tuyến lớn nhất Việt Nam với
                                                                                            đa dạng các loại sản phẩm
                                                                                            chất lượng cao đi cùng với
                                                                                            chế độ ưu đãi khách hàng cực
                                                                                            lớn!</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
