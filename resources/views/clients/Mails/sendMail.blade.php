                ...
                <tbody>
                    <tr>
                        <td valign="top" bgcolor="#FFFFFF" width="100%">
                            <table width="100%" role="content-container" class="outer" align="center"
                                                                        ...
                                                                        <td role="modules-container"
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td
                                                                                                            ...
                                                                                                            <table
                                                                                                                ...
                                                                                                                <tbody>
                                                                                                                    <tr>
                                                                                                                        <td style="padding:50px 30px 18px 30px; line-height:36px; background-color:#ffffff;"
                                                                                                                            height="100%" width="100%" valign="top" bgcolor="#ffffff" role="module-content">
                                                                                                                                <div style="font-family: inherit; text-align: center;">
                                                                                                                                    <p style="font-size: 30px;">{{ $detail['title'] }}</p>
                                                                                                                                </div>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                </tbody>
                                                                                                                        ...
                                                                                                                        <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;"
                                                                                                                            ...
                                                                                                                            <div>
                                                                                                                                <div style="font-family: inherit;">
                                                                                                                                    <p style="font-size: 18px">{!! $detail['message'] !!}</p>
                                                                                                                                </div>
                                                                                                                                <div></div>
                                                                                                                                <div
                                                                                                                                    style="font-family: inherit; text-align: right;">
                                                                                                                                    <span
                                                                                                                                        style="color: #ffbe00; font-size: 12px"><strong>Ngày gửi: {{ $detail['day_send'] }}</strong></span>
                                                                                                                                </div>
                                                                                                                            </div>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                            ...
                                                                            <div data-role="module-unsubscribe"
                                                                                ...
                                                                                <div class="Unsubscribe--addressLine">
                                                                                    <h3 class="Unsubscribe--senderName"
                                                                                    ...
                                                                                    <p
                                                                                        ...
                                                                                        <span
                                                                                            class="Unsubscribe--senderAddress">Email:
                                                                                            {{ $detail['email'] }}</span>
                                                                                    </p>
                                                                                    <p
                                                                                        style="font-size:15px; line-height:20px;">
                                                                                        <span
                                                                                            class="Unsubscribe--senderAddress">Số điện thoại:
                                                                                            {{ $detail['phone'] }}</span>
                                                                                    </p>
                                                                                </div>
                                                                                <h2
