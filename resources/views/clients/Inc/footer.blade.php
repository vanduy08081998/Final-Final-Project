      ...
      <div class="row pb-2">
        ...
        <div class="col-md-4 col-sm-6">
          <div class="widget widget-links widget-light pb-2 mb-4">
            ...
            <ul class="widget-list">
              <li class="widget-list-item"><a class="widget-list-link" href="#">Tài khoản của bạn</a></li>
              <li class="widget-list-item"><a class="widget-list-link" href="#">Giao hàng &amp; Điều khoản</a></li>
              <li class="widget-list-item"><a class="widget-list-link" href="#">Thông tin đổi trả</a></li>
              <li class="widget-list-item"><a class="widget-list-link" href="#">Theo dõi đơn hàng</a></li>
              <li class="widget-list-item"><a class="widget-list-link" href="#">Thuế và Phí</a></li>
            </ul>
          </div>
          <div class="widget widget-links widget-light pb-2 mb-4">
            <h3 class="widget-title text-light">Thông tin cửa hàng</h3>
            <ul class="widget-list">
              <li class="widget-list-item"><a class="widget-list-link" href="#">Về Công ty</a></li>
              ...
              <li class="widget-list-item"><a class="widget-list-link" href="#">Tin tức</a></li>
            </ul>
          </div>
        </div>
        <div class="col-md-4">
          <div class="widget pb-2 mb-4">
            ...
            <form class="subscription-form validate" action="" method="post" name="mc-embedded-subscribe-form" novalidate>
              <div class="input-group flex-nowrap"><i class="ci-mail position-absolute top-50 translate-middle-y text-muted fs-base ms-3"></i>
                <input class="form-control rounded-start" type="email" name="EMAIL" placeholder="Nhập Email của bạn..." required>
              ...
              <div class="form-text text-light opacity-50">*Đăng ký để nhận các tin tức và khuyến mãi mới nhất.</div>
    ...
    <div class="pt-5 bg-darker">
      <div class="container">
        <div class="row pb-3">
          <div class="col-md-3 col-sm-6 mb-4">
            <div class="d-flex"><i class="ci-rocket text-primary" style="font-size: 2.25rem;"></i>
              <div class="ps-3">
                ...
                <p class="mb-0 fs-ms text-light opacity-50">Miễn phí vận chuyển cho đơn hàng<br> > 2.000.000VND</p>
              </div>
            </div>
          </div>
          <div class="col-md-3 col-sm-6 mb-4">
          ...
          <div class="col-md-3 col-sm-6 mb-4">
            <div class="d-flex"><i class="ci-security-check text-primary" style="font-size: 2.25rem;"></i>
              <div class="ps-3">
