      ...
      <div class="col-lg-4 pt-4 pt-lg-0">
            ...
            <ul class="list-promotions">
              <li class="item-promotion general-promotion"><a
                  ...
                  thẻ tín dụng BIDV, Standard Charter (số lượng có hạn)&nbsp;<span class="color-red">(xem chi
                    tiết)</span></a></li>
              <li class="item-promotion general-promotion"><a href="https://cellphones.com.vn/thu-cu-doi-moi">Thu cũ
                  lên
        ...
        <div class="box-promotion-more">
          ...
          <div class="box-content">
            <ul class="list-promotions">
              <ul>
                <li class="item-promotion"><a href="https://cellphones.com.vn/smember" target="_blank">Giảm thêm tới
                    1%
