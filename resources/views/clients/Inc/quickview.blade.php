                        ...
                        <div class="product-gallery">
                            <div class="product-gallery-preview order-sm-2">
                                <div class="product-gallery-preview-item active" id="first"><img class="image-zoom"
                                        ...
                                        data-zoom="{{ 'frontend/img/shop/single/gallery/05.jpg' }}"
                                        alt="Product image">
                            ...
                            <div class="product-gallery-thumblist order-sm-1"><a
                                    class="product-gallery-thumblist-item active" href="#first"><img
                                        src="{{ asset('frontend/img/shop/single/gallery/th05.jpg') }}"
                                        alt="Product thumb"></a><a class="product-gallery-thumblist-item"
                                    href="#second"><img src="{{ asset('frontend/img/shop/single/gallery/th06.jpg') }}"
                                        alt="Product thumb"></a><a class="product-gallery-thumblist-item"
                                    href="#third"><img src="{{ asset('frontend/img/shop/single/gallery/th07.jpg') }}"
                                        alt="Product thumb"></a><a class="product-gallery-thumblist-item"
                                    href="#fourth"><img
                                        src="{{ asset('frontend/img/shop/single/gallery/th08.jpg') }}"
                    ...
                    <div class="col-lg-5 pt-4 pt-lg-0 image-zoom-pane">
                        <div class="product-details ms-auto pb-3">
                            <div class="mb-2">
                                ...
                                </div><span class="d-inline-block fs-sm text-body align-middle mt-1 ms-1">74 Đánh
                                    giá</span>
                            </div>
                            ...
                            <div class="position-relative me-n4 mb-3">
                                ...
                                <div class="product-badge product-available mt-n1"><i class="ci-security-check"></i>Sản
                                    phẩm còn hàng</div>
                            </div>
                            ...
                            <h6 class="fs-sm mb-2">Tổng quan</h6>
                            <ul class="fs-sm pb-2">
                            ...
                            <h6 class="fs-sm mb-2">Thông số kỹ thuật</h6>
                            <ul class="fs-sm pb-2">
