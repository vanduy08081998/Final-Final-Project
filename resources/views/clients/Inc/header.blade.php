    ...
    <div class="container">
      ...
      <div data-url="{{ route('wishlist.show_icon_wishlist') }}"
        ...
        <a class="topbar-link ms-3 ps-3 border-start border-light d-none d-md-inline-block" href="comparison.html"><i
            class="ci-compare mt-n1"></i>So sánh (3)
        </a>
    ...
    <div class="navbar navbar-expand-lg navbar-light">
      <div class="container">
        ...
        <form class="input-group d-none d-lg-flex flex-nowrap mx-4 typeahead search-form-header"
          ...
          <input class="form-control rounded-start w-100 search-input" style="border-radius: 25px 0 0 25px !important;"
            name="key" id="search" type="text" placeholder="Tìm kiếm sản phẩm" required>
          ...
          @if (Auth::user())
            <div class="user-ct" style="position: relative">
              ...
              <div class="content-user">
                <ul>
                  <li><a href="{{ route('account.order-list') }}"><i class="fas fa-file-invoice-dollar"></i> Đơn
                      hàng</a></li>
                  <li>
                          ...
                          <div class="widget widget-links">
                            ...
                            <ul class="widget-list">
                              @foreach ($cate->brands as $brand)
                                <li class="widget-list-item pb-1"><a class="widget-list-link" href="#"><img
                                      src="{{ url($brand->brand_image) }}" height="100" width="55">
