  ...
  <div class="widget widget-cart px-3 pt-2 pb-3" style="width: 20rem;">
    <div style="height: 15rem;" data-simplebar data-simplebar-auto-hide="false">
      ...
      <div class="widget-cart-item pb-2 border-bottom" id="cart_dropdown_{{ $key }}">
        <button class="btn-close text-danger btn-cart-remove" type="button" data-handle="remove"
        ...
        <div class="d-flex align-items-center"><a class="d-block flex-shrink-0" href="shop-single-v2.html">
          ...
          <div class="ps-2">
            <h6 class="widget-product-title"><a
                href="{{ URL::to('/shop/product-details', \App\Models\Product::where('product_name', $item->product_name)->first()->product_slug) }}">{{
                $item->product_name }}</a>
            </h6>
            <div class="widget-product-meta"><span class="text-accent me-2">{{ number_format($value->quantity *
                $item->variant_price) }}</small></span><span class="text-muted">x
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center py-3">
      <div class="fs-sm me-2 py-2"><span class="text-muted">Tổng:</span><span class="text-accent fs-base ms-1">{{
          number_format($totalprice) }}</span></div><a class="btn btn-cart-view-dropdown btn-sm"
