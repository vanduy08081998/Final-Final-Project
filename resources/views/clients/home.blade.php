          ...
          <div class="col-xl-3 order-xl-1 pt-4 mt-3 mt-xl-0 pt-xl-0">
            <div class="table-responsive" data-simplebar>
              <div class="d-flex d-xl-block"><a class="d-flex align-items-center bg-faded-info rounded-3 pt-2 ps-2 mb-4 me-4 me-xl-0" href="#" style="min-width: 16rem;"><img src="{{ asset('frontend/img/home/banners/banner-sm01.png') }}" width="125" alt="Banner">
                ...
                </a><a class="d-flex align-items-center bg-faded-warning rounded-3 pt-2 ps-2 mb-4 me-4 me-xl-0" href="#" style="min-width: 16rem;"><img src="{{ asset('frontend/img/home/banners/banner-sm02.png') }}" width="125" alt="Banner">
                  <div class="py-4 px-2">
                ...
                </a><a class="d-flex align-items-center bg-faded-success rounded-3 pt-2 ps-2 mb-4" href="#" style="min-width: 16rem;"><img src="{{ asset('frontend/img/home/banners/banner-sm03.png') }}" width="125" alt="Banner">
                  <div class="py-4 px-2">
