      ...
      <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb breadcrumb-light flex-lg-nowrap justify-content-center justify-content-lg-start">
            <li class="breadcrumb-item"><a class="text-nowrap" href="{{ route('clients.index') }}"><i class="ci-home"></i>Trang
                chủ</a></li>
            ...
            <div class="d-sm-flex justify-content-between align-items-center my-2 pb-3 border-bottom" id="cart_{{ $index }}">
              ...
              <div class="pt-2  ps-sm-3 text-center text-sm-start">
                ...
                <div class="d-flex text-center mx-auto form-quantity">
                  ...
                  <input class="form-control quantity_number" type="number" id="quantity1" min="1" value="{{ $cart->quantity }}">
                  <button class="inc">+</button>
                </div>

                <button class="btn btn-link px-0 text-danger delete_button" type="button"><i class="ci-close-circle me-2"></i><span
                    class="fs-sm">Xóa</span></button>
              </div>
            </div>
          @endforeach
        @endforeach
        {{-- <button class="btn btn-outline-accent d-block w-100 mt-4" type="button"><i class="ci-loading fs-base me-2"></i>Cập
          nhật
          giỏ hàng</button> --}}
      </section>
      <!-- Sidebar-->
          ...
          <div class="py-2 px-xl-2">
            ...
            <div class="accordion" id="order-options">
              <div class="accordion-item">
                <h3 class="accordion-header"><a class="accordion-button" href="#promo-code" role="button" data-bs-toggle="collapse"
                    aria-expanded="true" aria-controls="promo-code">Áp dụng mã
                    giảm giá</a></h3>
            ...
            </div><a class="btn btn-primary btn-shadow d-block w-100 mt-4" href="checkout-details.html"><i class="ci-card fs-lg me-2"></i>Tiến
              hành thanh toán</a>
          </div>
        </div>
      </aside>
