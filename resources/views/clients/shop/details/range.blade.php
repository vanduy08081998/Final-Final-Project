     ...
     <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
         <div class="card product-card">
            ...
            <i class="ci-heart"></i>
             ...
             @else
                 <button class="btn-wishlist_{{ $pro->id }} btn-sm" type="button" data-bs-toggle="tooltip"
                     data-bs-placement="left" title="Thêm vào yêu thích" onclick="add_to_wishlist({{ $pro->id }})">
                     <i class="ci-heart"></i>
                 </button>
             @endif
