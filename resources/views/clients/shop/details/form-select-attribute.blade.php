      ...
      <div class="product-details ms-auto pb-3">
        ...
        <div class="price-and-icon mt-3">
          ...
          <div class="style-sc-11ucdwk-0 jfBwzZ">
            ...
            <div class="item mt-3"><span> <span><i
        ...
        <div class="fs-sm mb-2"><span class="text-heading fw-medium me-1">{{ \App\Models\Attribute::where('id',
            $item->attribute_id)->first()->name }}:
        </div>
