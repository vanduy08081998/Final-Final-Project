                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
                            <div class="card product-card">
                                ...
                                <div class="card-body py-2"><a
                                        class="product-meta d-block fs-xs pb-1 category-name text-center"
                                    ...
                                    <div class="d-flex justify-content-between">
                                        @if ($pro->discount != 0)
                                            ...
                                            <div class="product-price" style="font-size: 12px">
                                                <span
                                                    style="text-decoration: line-through">{{ number_format($pro->unit_price) }}
                                                    ₫</span>
                                            </div>
                                ...
                                <div class="card-body card-body-hidden text-center" id="card-body"
                                    ...
                                    @if (Auth::user() != null)
                                        ...
                                        ?>
                                        @if ($wishlist != null)
                                            <a class="btn-wishlist_{{ $pro->id }} nav-link-style me-3"
                                                style="cursor: pointer" onclick="add_to_wishlist({{ $pro->id }})">
                                                <i class="ci-heart"></i>
                                            </a>
