                ...
                <div>
                    <div class="card product-card card-static">
                        <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip" data-bs-placement="left"
                            ...
                            class="card-img-top d-block overflow-hidden" href="#"><img src="{{ asset($proOther->product_image) }}"
                                alt="Product"></a>
                        <div class="card-body py-2"><a class="product-meta d-block fs-xs pb-1" href="#"></a>
                            <h3 class="product-title fs-sm"><a href="#">{{ trans($proOther->product_name) }}</a></h3>
