...
<head>
    <title>Gambo-SupperMarket</title>
                            ...
                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%"
                                ...
                                <tr>
                                    <td align="center"
                                        ...
                                        <img src="https://www.hartfordschools.org/wp-content/uploads/2019/03/contract.png"
                                ...
                                <tr>
                                    <td align="left"
                                        ...
                                        <p
                                            ...
                                            Đơn hàng của bạn đang được giao đến! Gambo - Cảm ơn quý khách!</p>
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                            <tr>
                                                ...
                                                <td width="25%" align="left"
                                                    style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 800; line-height: 24px; padding: 10px; border-top: 3px solid #eeeeee; border-bottom: 3px solid #eeeeee;">
                                                    {{ number_format($detail['total']) }} vnđ</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                            ...
                                            <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%"
                                                ...
                                                <tr>
                                                    <td align="left" valign="top"
                                                        style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px; float: left;">
                                                        <p style="font-weight: 1200;">Địa chỉ nhận hàng: </p>
                                                        <p>Họ & tên: {{ $detail['fullname1'] }}<br>
                                                            Sđt: {{ $detail['phone1'] }}<br>
                                                            Địa chỉ: {{ $detail['address1'] }}
                                                        </p>
                                                    </td>
                                                </tr>
                                            </table>
