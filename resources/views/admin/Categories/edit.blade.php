                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="meta_desc" id="meta_desc" cols="30"
                                                rows="10">{{ $category->meta_desc ?? '' }}</textarea>
                                            @error('meta_desc')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card radius-5">
                                <div class="card-body">
                                            ...
                                            @foreach (App\Models\Category::where('category_parent_id', null)->get() as $item)
                                                ...
                                                @foreach ($item->subcategory()->get() as $childCategory)
                                                    ...
                                                    @foreach ($childCategory->subcategory()->get() as $childCategory2)
                                                        ...
                                                        $childCategory2,'category' => $category, 'prefix' => '----'])
                                                    @endforeach
                                                @endforeach
                                            @endforeach
                                    ...
                                    <div class="d-block">
                                        <button type="submit" class="btn btn-primary radius-5 float-right" id="submit1">Cập
                                            nhật</button>
                                    </div>
                                </div>
                            </div>
