                        ...
                        <form action="{{ route('categories.store') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        @foreach (App\Models\Category::where('category_parent_id', null)->get() as $item)
                                            ...
                                            @foreach ($item->subcategory()->get() as $childCategory)
                                                ...
                                                @foreach ($childCategory->subcategory()->get() as $childCategory2)
                                                    @include('admin.Categories.categoryOptions', ['item' => $childCategory2,
                                                    'prefix' => '----'])
                                                @endforeach
                                            @endforeach
                                        @endforeach
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="meta_desc" id="meta_desc" type="text" cols="30"
                                        rows="10"></textarea>
                            ...
                            <div class="col-md-12 mb-3">
                                <button type="submit" class="btn btn-primary radius-30" id="submit1"> <i
                                        class="bx bx-cog"></i> Thêm danh mục</button>
                            </div>
