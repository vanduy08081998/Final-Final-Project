            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown dropdown-user-profile">
                    <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="javascript:;"
                        ...
                        <div class="media user-box align-items-center">
                            <div class="media-body user-info">
                                ...
                                <p class="designattion mb-0 text-success">Admin</p>
                            </div>
                            <img src="{{ URL::to('Backend/images/avatars/avatar-1.png') }}" class="user-img"
                                alt="user avatar">
                        </div>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right"> <a class="dropdown-item" href="javascript:;"><i
                        ...
                        <a class="dropdown-item" href="javascript:;"><i class="bx bx-cog"></i><span>Thiết lập</span></a>
                        ...
                        <a class="dropdown-item" href="{{ route('logout') }}" onclick="">
                            ...
                            <form action="{{ route('logout') }}" method="POST">
                                @csrf
                                <button class="btn btn-danger" type="submit"> <i class="bx bx-power-off"></i><span>Đăng
                                        xuất</span></button>
                            </form>
                        </a>
