                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="meta_description" id="meta_desc" type="text" cols="30"
                          rows="10"></textarea>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <select name="colors[]" id="product_color" class="form-control" multiple="multiple" disabled>
                          @foreach (\App\Models\Color::all() as $color)
                            <option value="{{ $color->color_code }}">
                              <span
                                style="color: red">{{ $color->color_name }}</span>
                            </option>
                          @endforeach
                        </select>
                      </div>
                    ...
                    <div class="card-body">
                      <ul class="list-group notification-list">
                        <li class="list-group-item">
                          Vận chuyển miễn phí
                          <div class="status-toggle">
                            <input type="radio" id="free_ship" name="shipping_type" value="free_ship"
                              class="check">
                          ...
                          <div class="card-body">
                            ...
                            <div id="attribute__and__variant">
                              ...
                              <div id="choiceAttribute">
                                <div class="form-group">
                                  <select name="attribute[]" id="attribute" class="form-control aiz-select-picker"
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-lg-12 col-12 col-xl-12">
                <div class="card">
                  <div class="card-body">
                    <div class="form-group">
                      <select name="choose_specification[]" style="width:100%" id="choose_specification"
                        class="form-control" multiple data-placeholder="{{ trans('Chọn thông số kỹ thuật') }}">
