                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input class="form-control" name="product_slug" type="text" id="convert_slug" required>
                      </div>
                      <div class="form-group">
                        <label>Đơn vị sản phẩm</label>
                        <input class="form-control" name="product_unit" type="text" id="convert_slug" required>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="meta_description" id="meta_desc" type="text" cols="30" rows="10"></textarea>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="card-header">
                      <ul class="list-group notification-list">
                        <li class="list-group-item">
                          Hiển thị thuộc tính
                          <div class="status-toggle">
                            <input type="radio" id="is__attribute" name="type_of_category" value="isAttribute" class="check" checked>
                    ...
                    <div class="card-body">
                      <ul class="list-group notification-list">
                        ...
                        <li class="list-group-item">
                          Vận chuyển nhanh
                          <div class="status-toggle">
                            <input type="radio" id="flat_rate" name="shipping_type" value="flat_rate" class="check" checked="">
                    ...
                    <div class="card-body">
                      ...
                      <ul class="list-group notification-list">
                        <li class="list-group-item">
                          ...
                          <div class="status-toggle">
                            <input type="radio" id="qt_total" name="show_hide_quantity" value="qt_total" class="check" checked="">
                        ...
                        <li class="list-group-item">
                          ...
                          <div class="status-toggle">
                            <input type="radio" id="qt_stock" name="show_hide_quantity" value="qt_stock" class="check" checked="">
