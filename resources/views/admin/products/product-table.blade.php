      ...
      <td>
        <div class="status-toggle">
          <input type="checkbox" id="feature_product_{{ $pro->id }}" onchange="featureProduct({{ $pro->id }})"
            name="feature_product" class="check" value="{{ $pro->feature_product }}" {{ $pro->feature_product == 'on' ?
          'checked' : '' }} onchange="productFeature({{ $pro->id }})">
      ...
      <td>
        <div class="status-toggle">
          <input type="checkbox" id="deals_today_{{ $pro->id }}" onchange="deals_today({{ $pro->id }})"
            name="deals_today" class="check" value="{{ $pro->deals_today }}" {{ $pro->deals_today == 1 ? 'checked' : ''
          }}
