                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input class="form-control" name="product_name" onchange="update_sku()" type="text" onkeyup="ChangeToSlug();"
                      ...
                      <div class="form-group">
                        ...
                        <input class="form-control" name="product_unit" type="text" id="convert_slug" value="{{ $product->product_unit }}"
                          required>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="meta_description" id="meta_desc" type="text"
                          placeholder="Enter your meta description" cols="30" rows="10">{{ $product->meta_description }}</textarea>
                      </div>
                    ...
                    <div class="card-body">
                      ...
                      @if ($product->colors != null)
                        <div class="form-group">
                          ...
                          <select name="colors[]" id="product_color" class="form-control" multiple="multiple" data-live-search="true"
                            disabled>
                    ...
                    <div class="card-header">
                      <ul class="list-group notification-list">
                        ...
                        <li class="list-group-item">
                          ...
                          <div class="status-toggle">
                            <input type="radio" id="is__not__attribute" name="type_of_category" value="isNotAttribute" class="check"
                              ...
                              <div class="card-body">
                                <div class="form-group mb-3">
                                  ...
                                  @if ($product->type_of_category == 'isAttribute')
                                    <input type="text" name="unit_price" id="" value="{{ $product->unit_price }}" class="form-control">
                                  @else
                                ...
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" name="ex_link" id="" class="form-control" value="{{ $product->ex_link }}">
                                </div>
                                      ...
                                      <select class="js-example-basic-multiple form-control" id="attribute" name="attribute[]"
                                        ...
                                        @foreach (App\Models\Attribute::all() as $attribute)
                                          @foreach (json_decode($product->product_attribute) as $key => $val)
                                            ...
                                            <option value="{{ $attribute->id }}" @if (in_array($attribute->id, $array_attribute)) selected @endif>
                                              {{ $attribute->name }}
                                            </option>
                                          @endforeach
                                        @endforeach
                                    ...
                                    @foreach (json_decode($product->choice_options) as $index => $options)
                                      <div class="form-group">
                                        ...
                                        <select name="attribute_value_{{ $options->attribute_id }}[]" multiple="multiple"
                                          data-live-search="true" class="form-control attribute-value" id="attribute-value">
                                          @foreach (\App\Models\Attribute::where('id', $options->attribute_id)->first()->variants()->get()
      as $variant)
                                            <option value="{{ $variant->name }}" @if (in_array($variant->name, $options->values)) selected @endif>
                                              {{ $variant->name }}</option>
                                          @endforeach
                                        </select>
                                      </div>
                              ...
                              <div class="card-body">
                                <div class="form-group mb-3">
                                  ...
                                  @if ($product->type_of_category == 'isNotAttribute')
                                    <input type="text" name="price" id="" class="form-control" value="{{ $product->unit_price }}">
                                  @else
                        ...
                        <li class="list-group-item">
                          ...
                          <div class="flat_rate_shipping_div mt-3">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="shipping_stock" value="{{ $product->shipping_stock }}">
                            </div>
                          </div>
                        </li>
                        <li class="list-group-item">
                          ...
                          <div class="status-toggle">
                            <input type="checkbox" id="multiple_stock" name="multiple_stock" class="check" @if ($product->multiple_stock == 'on') checked @endif>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div class="form-group">
                        ...
                        <input type="text" name="shipping_day" id="" class="form-control" value="{{ $product->shipping_day }}">
                      </div>
                    ...
                    <div class="card-body">
                      ...
                      <ul class="list-group notification-list">
                        ...
                        <li class="list-group-item">
                          Không hiển thị
                          <div class="status-toggle">
                            <input type="radio" id="stock_hidden" name="show_hide_quantity" value="qt_hidden" class="check"
                        ...
                        <select name="id_flash_deal[]" id="id_flash_deal" class="form-control" multiple="multiple" data-live-search="true">
                          @foreach ($flash_deals as $deal)
                            @foreach ($product->flash_deals as $flash_deal)
                              <option value="{{ $deal->id }}" @if ($flash_deal->id == $deal->id) selected @endif>{{ $deal->title }}</option>
          ...
          <div class="row">
            <div class="col-sm-8">
              <button type="submit" class="btn btn-success btn-flat btn-addon m-b-10 m-l-5"><i class="fa fa-check"></i>Cập nhật sản phẩm
              </button>
