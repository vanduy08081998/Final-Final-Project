...
<div class="header">
		...
		<div class="header-left">
				<a href="index.html" class="logo">
						<img src="{{ URL::to('backend/img/logo.png') }}" width="40" height="40"
		...
		<div class="page-title-box">
				<h3 style="font-style: italic">BigDeal - Trang quản trị</h3>
		</div>
		<!-- /Header Title -->

		<a id="mobile_btn" class="mobile_btn" href="#sidebar" style="margin-top: 10px"><i
		...
		<ul class="nav user-menu">
				...
				<li class="nav-item dropdown has-arrow flag-nav">
						<a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button">
								<img src="{{ URL::to('backend/img/flags/us.png') }}" alt="" height="20">
								<span>English</span>
						</a>
						<div class="dropdown-menu dropdown-menu-right">
								<a href="javascript:void(0);" class="dropdown-item">
										<img src="{{ URL::to('backend/img/flags/us.png') }}" alt="" height="16"> English
								</a>
								<a href="javascript:void(0);" class="dropdown-item">
										<img src="{{ URL::to('backend/img/flags/fr.png') }}" alt="" height="16"> French
								</a>
								<a href="javascript:void(0);" class="dropdown-item">
										<img src="{{ URL::to('backend/img/flags/es.png') }}" alt="" height="16"> Spanish
								</a>
								<a href="javascript:void(0);" class="dropdown-item">
										<img src="{{ URL::to('backend/img/flags/de.png') }}" alt="" height="16"> German
								</a>
						</div>
				</li>
				<!-- /Flag -->
