...
<div class="content container-fluid">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <!--end breadcrumb-->
            <form action="{{ route('brand.update', ['brand' => $brandId->id]) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-lg-8">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="brand_name" onkeyup="ChangeToSlug();" id="slug" value="{{ $brandId->brand_name }}" type="text">
                                        @error('brand_name')
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="brand_slug" id="convert_slug" value="{{ $brandId->brand_slug }}" type="text">
                                        @error('brand_slug')
                        ...
                        <div class="card radius-5">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" data-role="tagsinput" name="meta_keywords" value="{{ $brandId->meta_keywords }}" type="text">
                                    @error('meta_keywords')
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select name="category_id[]" class="js-example-basic-multiple form-control" multiple="multiple" data-live-search="true">
                            ...
                            <div class="card-footer">
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" name="brand_image" onchange="readURL(this);" class="custom-file-input" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04">
