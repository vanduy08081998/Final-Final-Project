    ...
    <div class="content container-fluid">
        ...
        <div class="page-content-wrapper">
            <div class="page-content">
                <!--breadcrumb-->
                <!--end breadcrumb-->
                <form action="{{ route('discount.update', ['discount' => $discountId->id]) }}" method="post"
                        ...
                        <div class="col-lg-8">
                            <div class="card radius-5">
                                <div class="card-header">
                                    <h4 class="font-weight-bold text-dark">Cập nhật phiếu giảm giá</h4>
                                </div>
                                <div class="card-body">
                                    @if (session('message'))
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="discount_code"
                                                value="{{ $discountId->discount_code }}" type="text">
                                            @error('discount_code')
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="discount_title"
                                                value="{{ $discountId->discount_title }}" type="text">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="discount_deduct"
                                                value="{{ $discountId->discount_deduct }}" type="text">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="discount_start"
                                            value="{{ $discountId->discount_start }}" type="date">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="discount_end"
                                            value="{{ $discountId->discount_end }}" type="date">
                                        @error('discount_end')
