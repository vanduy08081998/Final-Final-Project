        ...
        <div class="col-lg-4 col-md-5 text-center">
            ...
            <div class="star-rating me-2 mb-1">
                @for ($count = 1; $count <= $rating_avg; $count++) <i
                        class="ci-star-filled fs-lg text-warning me-1"></i>
                @endfor
                @for ($count = 1; $count <= 5 - $rating_avg; $count++) <i
                        class="ci-star fs-lg text-warning me-1"></i>
                @endfor
            </div>

            <p class="pt-3 fs-sm text-muted">{{ $introduce_review }} trên {{ $all_count_review }}
                ({{ round(($introduce_review / $all_count_review) * 100) }}%)<br>Khách hàng sẽ giới thiệu sản phẩm
                này</p>
        </div>
    </div>
                ...
                <div class="product-review pb-4 mb-4 border-bottom">
                    ...
                    <div class="text-nowrap">
                        ...
                        <button class="btn-time-comment text-muted" type="button"><i class="fa fa-comment-o"
                                aria-hidden="true"></i> Đã đánh giá khoảng
