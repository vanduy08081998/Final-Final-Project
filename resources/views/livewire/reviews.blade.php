<div class="container" wire:ignore.self>
    <!-- Reviews-->
    <h4 class="col-lg-12 mb-5"> {{ $all_count_review }} đánh giá {{ $product->product_name }}
    </h4>
        ...
        <div class="col-md-8">
            ...
            <div class="list-review mt-3">
                ...
                @if ($count_review != 0)
                    ...
                    @endforeach
                @else
                    <p>Rất tiếc, không tìm thấy kết quả phù hợp </p>
                @endif
    ...
    <a href="{{ route('review.show-review', $product->product_slug) }}">Xem đánh giá chi tiết</a>
</div>
